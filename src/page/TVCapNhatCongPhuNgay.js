        ...
        <Form>
          <Item style={s.item}>
            <View style={[{padding:5, backgroundColor: Colors.navbarBackgroundColor, width: "100%", marginTop: 10}]}>
              <Text style={{color: "#ffffff"}}>Tuần {this.week}/{this.month}, Ngày {funcs.getValueFromServerDate(this.date, "day") + "/" + funcs.getValueFromServerDate(this.date, "month")}</Text>
            </View>
          </Item>
          ...
          <Item stackedLabel style={s.item}>
            <View style={{flexDirection : "row",justifyContent: "space-between", alignItems: "center", width: "100%"}}>
              <Label>Thời gian rãnh<Text style={styles.required}>{" *"}</Text></Label>
